    ...
    <div className="col-md-6">
          ...
          <div className="form-group">
            ...
            <div className="form-group">
              ...
              <select className="form-control" name='provincia' onChange={ handleChangeMunicipio} size={6} defaultValue={formData.provincia}>
        {
        ...
        <option key={provincia.id} value={provincia.id} >{provincia.name}</option>
            ...
            <div className="form-group">
              ...
              <select className="form-control" name='municipio' onChange={handleChangeDistrito} size={6} defaultValue={formData.municipio}>
        {
        ...
        <option key={municipio.id} value={municipio.id}>{municipio.name}</option>
            ...
            <div className="form-group">
              ...
              <select className="form-control" name='distrito' defaultValue={formData.distrito} size={5} onChange={handleChange}>
