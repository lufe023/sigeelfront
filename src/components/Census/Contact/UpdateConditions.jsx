      ...
      <div className="card-body">
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label htmlFor={`detalleCondicion${citizenID}`}>Resumen condición</label>
            <input
              type="text"
          ...
          <div className="form-group">
            <div className="custom-control custom-checkbox">
              ...
              />
              <label htmlFor={`dyslexia${citizenID}`} className="custom-control-label">
                Dislexia
              </label>
            </div>
            ...
            <div className="custom-control custom-checkbox">
              ...
              />
              <label htmlFor={`visual${citizenID}`} className="custom-control-label">
                Visual
              </label>
            </div>
            ...
            <div className="custom-control custom-checkbox">
              ...
              />
              <label htmlFor={`auditory${citizenID}`} className="custom-control-label">
                Auditivo
              </label>
            </div>
            ...
            <div className="custom-control custom-checkbox">
              ...
              />
              <label htmlFor={`motor${citizenID}`} className="custom-control-label">
                Motor
              </label>
            </div>
            ...
            <div className="custom-control custom-checkbox">
              ...
              />
              <label htmlFor={`cognitive${citizenID}`} className="custom-control-label">
                Cognitivo
              </label>
            </div>
            ...
            <div className="custom-control custom-checkbox">
              ...
              />
              <label htmlFor={`outside${citizenID}`} className="custom-control-label">
                Vive fuera
              </label>
            </div>
          </div>
