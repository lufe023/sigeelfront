    ...
    const deletePeople = (peopleId, peopleName, leaderId) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire("Eliminado", "Accion realizada con éxito", "success");
                const URL = `${
                    import.meta.env.VITE_API_SERVER
                }/api/v1/census/removepeople`;
                axios
                    .post(
                        URL,
                        {
        ...
        <div className="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
            <div className="card">
                                ...
                                <div className="col-7">
                                    ...
                                    <ul className="ml-4 mb-0 fa-ul text-muted">
                                        ...
                                        >
                                            ...
                                            Celular:{" "}
                                            <a href={`tel:${people.celphone}`}>
                                                {people.celphone}
                                            </a>
                                        </li>
                                        <li
                                            className={`small  ${
                                                isFieldUpdated("telephone")
                                                    ? ""
                                                    : "not-updated"
                                            }`}
                                        >
                                            ...
                                            Telefono:{" "}
                                            <a href={`tel:${people.telephone}`}>
                                                {people.telephone}
                                            </a>
                                        </li>
                                        <li
                                            className={`small  ${
                                                isFieldUpdated("otherPhone")
                                                    ? ""
                                                    : "not-updated"
                                            }`}
                                        >
                                ...
                                <li key={result.id}>
                                    <div className="info-box">
                                        ...
                                        <div className="info-box-content">
                                            ...
                                            <Link
                                                to={`/people/poll/${result.id}/${people.firstName} ${people.lastName}`}
                ...
                <div className="card-footer">
                    ...
                    {people?.geolocation ? (
                        <a
                            href={`https://www.google.com/maps/search/${people?.geolocation?.latitud},+${people?.geolocation?.longitud}?shorturl=1`}
                            className="btn btn-app bg-dark"
                            target={"_blank"}
                        >
                    ...
                    <a
                        href={`https://api.whatsapp.com/send?phone=${people?.celphone
                            ?.substring(1, people?.celphone?.length)
                            .split("-")
                            .join("")}&text=Hola ${
                            people?.firstName
                        } ¿Qué tal?`}
                    ...
                    <a
                        href={`https://t.me/${people?.celphone}`}
