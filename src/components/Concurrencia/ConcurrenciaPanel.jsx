...
const ConcurrenciaPanel = ({ citizens }) => {
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                >
                                    <ul
                                        className="users-list-panel clearfix"
                                                        ...
                                                        <div className="info-box-content">
                                                            ...
                                                            >
                                                                <span className="info-box-text">
                                                                    {citizen.firstName.substring(
                                                                        0,
                                                                        10
                                                                    )}{" "}
                                                                    {citizen.lastName.substring(
                                                                        0,
                                                                        10
                                                                    )}
                                                                </span>
    ...
    <span className="users-list-date text-success">Votó</span><small>10:40 am</small> */}
                                ...
                                {/* contenido 2*/}
                                <div
                                    className="col-md-4 condition-details"
                                    style={{
