    ...
    const getDashboard = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                setPreferedDirector(
                    res.data.dashboard[0].preferedDistrictDirector
                );
                setPreferedCouncillor(res.data.dashboard[0].preferedCouncillor);
                setPreferedVocal(
                    res.data.dashboard[0].preferedDistrictCouncillor
                );
            ...
            .catch((err) => {
                ...
                setPreferedParties(
                    err.response.data.dashboard[0].preferedParty
                );
                setPreferedPresidents(
                    err.response.data.dashboard[0].preferedPresident
                );
                setPreferedSenators(
                    err.response.data.dashboard[0].preferedSenator
                );
                setPreferedDiputys(
                    err.response.data.dashboard[0].preferedDiputy
                );
                setPreferedMayor(err.response.data.dashboard[0].preferedMayor);
                setPreferedDirector(
                    err.response.data.dashboard[0].preferedDistrictDirector
                );
                setPreferedCouncillor(
                    err.response.data.dashboard[0].preferedCouncillor
                );
                setPreferedVocal(
                    err.response.data.dashboard[0].preferedDistrictCouncillor
                );
                ...
                <section className="content">
                    <div className="container-fluid">
                        ...
                        <MiniDatos
                            ...
                            citizens={dashboard.ciudadanos.rows}
                        />
                        {dashboard.ciudadanos.rows ? (
                            <ConcurrenciaPanel
                                citizens={dashboard.ciudadanos.rows}
                        ...
                        <div className="row">
                            ...
                            <section className="col-lg-6 connectedSortable ui-sortable">
                                {preferedPresidents.length > 0 ? (
                                    <BarsChart
                                        preferedPresidents={preferedPresidents}
                                    />
                                ) : (
                                    ""
                                )}
                                {preferedSenators.length > 0 ? (
                                    <SenatorsBarsChart
                                        preferedSenators={preferedSenators}
                                    />
                                ) : (
                                    ""
                                )}

                                {preferedDiputys.length > 0 ? (
                                    <DiputyBarsChart
                                        preferedDiputys={preferedDiputys}
                                    />
                                ) : (
                                    ""
                                )}
                                {preferedMayor.length > 0 ? (
                                    <MayorBarsChart
                                        preferedMayor={preferedMayor}
                                    />
                                ) : (
                                    ""
                                )}
                            ...
                            <section className="col-lg-6 connectedSortable ui-sortable">
                                {preferedParties.length > 0 ? (
                                    <DonutChart
                                        preferedParties={preferedParties}
                                    />
                                ) : (
                                    ""
                                )}
                                {preferedCouncillor.length > 0 ? (
                                    <CouncillorBarsChart
                                        preferedCouncillor={preferedCouncillor}
                                    />
                                ) : (
                                    ""
                                )}

                                {preferedDirector.length > 0 ? (
                                    <DirectorBarsChart
                                        preferedDirector={preferedDirector}
                                    />
                                ) : (
                                    ""
                                )}

                                {preferedVocal.length > 0 ? (
                                    <VocalBarsChart
                                        preferedVocal={preferedVocal}
                                    />
                                ) : (
                                    ""
                                )}
