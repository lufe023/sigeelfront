            ...
            <div className="card">
                <div className="card-header">
                    <h3 className="card-title">
                        Todos los Equipos{" "}
                        <span className="badge bg-teal">{count}</span>
                    </h3>
                </div>
            </div>
            <div className="row">
                                        ...
                                        >
                                            <div className="product-img">
                                                <Link
                                                    ...
                                                    to={`/mypeople/${member.memberData.censu.id}`}
                                                >
                                                    <img
                                                        src={`${
                                                            import.meta.env
