...
const CollaboratorDashboard = ({UserId, UserName}) => {
...
if(id !='Cargando'){
  ...
  <div className="content-header bg-dark" style={{position:'sticky', top:'0px', zIndex:'1', backgroundColor:'#f8f9fa', boxShadow:'0px 1px 1px rgba(0, 0, 0, 0.19)', marginBottom:'20px' }}>
    <div className="container-fluid">
      <div className="row mb-2">
        <div className="col-sm-6">
          <h1 className="m-0">Panel de: {UserName}</h1>
        </div>{/* /.col */}
        <div className="col-sm-6">
